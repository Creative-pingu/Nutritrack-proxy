// Map global Lucide icons to local variables for the app
const { 
  Activity, ChevronLeft, ChevronRight, Plus, Search, 
  Settings, Save, Trash2, Edit2, Check, AlertCircle,
  RefreshCw, Download, Upload, History, Info, X
} = window.lucide || {};
