...
export default function NutriTrack() {
    ...
    return (
      <div style={S.app}>
        ...
        <div style={S.section}>
          ...
          <div style={{...S.card,background:"#0f172a",marginBottom:4}}>
            <div style={{fontSize:13,fontWeight:700,color:"#94a3b8",marginBottom:8,textTransform:"uppercase",letterSpacing:"0.05em"}}>How goals work</div>
            <div style={{fontSize:12,color:"#64748b",lineHeight:1.6}}>Goals are computed from your profile using BMR/TDEE formulas and vegan-adjusted RDAs. Override any value by typing in the field — it highlights in amber. Tap ↺ to restore the computed value.</div>
            {hasProfile && (
              <div style={{marginTop:10,padding:"8px 10px",background:"#0a0f1a",borderRadius:8,fontSize:12,color:"#94a3b8"}}>
  ...
  if (view === "proDetail") {
    ...
    let limitingKey="aaLys",lowestPct=Infinity; AA_KEYS.forEach(k=>{const p=(aaTotals[k]/aaGoals[k])*100;if(p<lowestPct){lowestPct=p;limitingKey=k;}});
