          ...
          {validationWarning && (
            <div style={{background:"#1c1000",border:"1px solid #92400e",borderRadius:12,padding:"12px 14px",marginBottom:10}}>
              ...
              <button
                ...
                onClick={()=>{
                  // Only remove keys that are genuinely unparseable (corrupted JSON).
                  // Shape mismatches (valid JSON, wrong type) are NOT deleted — the
                  // corruptedKeys guard has already protected the real data in localStorage
                  // from being overwritten. Just dismiss the banner and reload so the
                  // app re-reads the protected original values.
